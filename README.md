...
A nice code explainer is available in the repo: [`Clipt_1.6_Code_Explainer.mp4`](Clipt_1.6_Code_Explainer.mp4)

This was generated by Google's NotebookLM, so take it with a pinch of salt, but honestly it does a surprisingly decent job of explaining the architecture and key design decisions. Not 100% low level blow by blow for sure and really punches my code up nicely, which is good for my ego :) 

Worth a watch if you want to understand the codebase without reading every file.
